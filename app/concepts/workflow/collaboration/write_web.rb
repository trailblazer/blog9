  ...
  module Collaboration
    ...
    WriteWeb = Trailblazer::Workflow.Collaboration(
      ...
      [
        ...
        ["web:edit_form?",            ->(process_model:) { ["created", "updated"].include?(process_model.state) }, before("catch-before-?Update!", "catch-before-?Notify approver!"), before("edit_form?", "request_approval?!"), start()],
