...
Moment =Trailblazer::Workflow::Moment::DSL
    ...
    WriteWeb = Trailblazer::Workflow::Collaboration::Schema.new(
      ...
      messages: {
        ...
        [:web, "revise_update!"] => [:lib, "catch-before-?Update!"],
      },
      options: {
        dictionary: Trailblazer::Workflow::Moment.Dictionary(
          ...
          ["web:revise_form?",         ->(process_model:) { process_model.state == "edit requested" }, Moment.before("catch-before-?Update!"), Moment.before("revise_form?"), Moment.before("Start.default")],
          ["web:revise_form_submitted?",         ->(process_model:) { process_model.state == "edit requested" }, Moment.before("catch-before-?Update!"), Moment.before("revise_form_submitted?", "revise_form_cancel?"), Moment.before("Start.default")],
